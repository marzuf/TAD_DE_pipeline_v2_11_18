startTime <- Sys.time()
cat(paste0("> Rscript scores_vs_other_variables_withBoxplots_noTCGA.R\n"))

#  Rscript scores_vs_other_variables_withBoxplots_noTCGA.R
...
outFold <- file.path("SCORES_VS_OTHER_VARIABLES_WITH_BOXPLOTS_noTCGA")
